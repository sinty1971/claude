...
export interface paths {
    ...
    "/kouji-projects": {
         ...
         */
        get: operations["getKoujiProjects"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
    ...
    "/kouji-projects/save": {
         ...
         * @description Save construction project information to YAML file
         */
        post: operations["saveKoujiProject"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
...
export interface components {
    schemas: {
        ...
        Kouji: {
            /**
             * @description Generated by Folder ID + CompanyName + LocationName
             * @example Generated by Folder ID + CompanyName + LocationName
             */
            id: string;
            /**
             * @description Construction company name
             * @example 豊田築炉
             */
            company_name: string;
            /**
             * @description Construction site location name
             * @example 名和工場
             */
            ...
            file_count: number;
            /**
             * @description Number of subdirectories in the project
             * @example 5
             */
            subdir_count: number;
            /**
             * @description Name of the project folder
             * @example 2025-0114 豊田築炉 名和工場
             */
            name: string;
            /**
             * @description Full path to the project folder
             * @example /home/user/projects/2025-0114 豊田築炉 名和工場
             */
            path: string;
            /**
             * @description Whether this item is a directory (always true for projects)
             * @example true
             */
            is_directory: boolean;
            /**
        ...
        KoujiListResponse: {
            /** @description List of kouji projects */
            kouji_list: components["schemas"]["Kouji"][];
            /**
        ...
        KoujiSaveRequest: {
             ...
             */
            project_path: string;
            project_data: components["schemas"]["Kouji"];
        };
        KoujiSaveResponse: {
            /**
            ...
            message: string;
            /**
             * @description Path where the project was saved
             * @example /home/user/projects/2025-0114 豊田築炉 名和工場/.inside.yaml
             */
            saved_path?: string;
        };
    };
...
export interface operations {
    ...
    getKoujiProjects: {
        parameters: {
            query?: {
                /** @description Path to the directory containing construction projects */
                path?: string;
            };
            header?: never;
            path?: never;
        ...
        responses: {
            ...
            200: {
                ...
                content: {
                    "application/json": components["schemas"]["KoujiListResponse"];
                };
            };
            /** @description Internal server error */
            500: {
    ...
    saveKoujiProject: {
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["KoujiSaveRequest"];
            };
        };
        responses: {
            /** @description Successful response */
            200: {
                ...
                content: {
                    "application/json": components["schemas"]["KoujiSaveResponse"];
                };
            };
